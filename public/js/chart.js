        ...
        6: [function(t, e, n) {
            ! function(t, i) {
                ...
                function xt(t, e) {
                    if (null !== e) {
                        var n = An;
                        if (e.abbr = t, null != On[t]) S("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), n = On[t]._config;
                ...
                function wt(t) {
                    var e, n, i, a, r, o, s = t._i,
                        l = Rn.exec(s) || Ln.exec(s);
                    if (l) {
                        for (g(t).iso = !0, e = 0, n = Yn.length; e < n; e++)
                            if (Yn[e][1].exec(l[1])) {
                                a = Yn[e][0], i = !1 !== Yn[e][2];
                                break
                            }
                ...
                function Tt(t) {
                    var e, n, i, a, r, o, s, l;
                    if (null != (e = t._w).GG || null != e.W || null != e.E) r = 1, o = 4, n = Dt(e.GG, t._a[rn], st(Nt(), 1, 4).year), i = Dt(e.W, 1), ((a = Dt(e.E, 1)) < 1 || a > 7) && (l = !0);
                    else {
                ...
                function Lt(t) {
                    ...
                    return t._locale = t._locale || _t(t._l), null === e || void 0 === n && "" === e ? p({
                        nullInput: !0
                    }) : ("string" == typeof e && (t._i = e = t._locale.preparse(e)), b(e) ? new y(kt(e)) : (l(e) ? t._d = e : i(n) ? Ot(t) : n ? It(t) : Wt(t), m(t) || (t._d = null), t))
                }
                ...
                function Bt(t) {
                    for (var e in t)
                        if (-1 === En.indexOf(e) || null != t[e] && isNaN(t[e])) return !1;
                    for (var n = !1, i = 0; i < En.length; ++i)
                        if (t[En[i]]) {
                            if (n) return !1;
                ...
                function be() {
                    ...
                    var t, e, n, i = _i(this._milliseconds) / 1e3,
                        a = _i(this._days),
                        r = _i(this._months);
                ...
                ei.add = Gn, ei.calendar = function(t, e) {
                    ...
                    if ("object" == typeof t)
                        for (var n = F(t = A(t)), i = 0; i < n.length; i++) this[n[i].unit](t[n[i].unit]);
                    else if (t = I(t), D(this[t])) return this[t](e);
                    return this
                        ...
                        if (i.display) {
                            ...
                            if (s.each(p, function(n, r) {
                                    if (void 0 !== n.label) {
                                        ...
                                        var y, b, x, k, w, M, A, O, F, R, L = "middle",
                                            W = "middle",
                                            Y = d.padding;
                                        if (m) {
                                            var N = _ + Y;
                                ...
                                var A, O, F = 0,
                                    R = l(f) / 2;
                                if (m) A = e.left + (e.right - e.left) / 2, O = "bottom" === i.position ? e.bottom - R - M.bottom : e.top + R + M.top;
                                else {
        ...
        57: [function(t, e, n) {
            ...
            function c(t, e, n, i) {
                ...
                for (a = k.indexOf(t); a < s - 1; ++a)
                    if (r = _[k[a]], o = r.steps ? r.steps[r.steps.length - 1] : x, Math.ceil((n - e) / (o * r.size)) <= i) return k[a];
                return k[s - 1]
            }

            function h(t) {
                for (var e = k.indexOf(t) + 1, n = k.length; e < n; ++e)
                    if (_[k[e]].major) return k[e]
            }
                    ...
                    n = t.Scale.extend({
                        ...
                        determineDataLimits: function() {
                            ...
                            for (t = 0, n = (d.data.datasets || []).length; t < n; ++t)
                                if (d.isDatasetVisible(t))
                                    if (o = d.data.datasets[t].data, y.isObject(o[0]))
                                        for (m[t] = [], e = 0, r = o.length; e < r; ++e) s = u(o[e], l), g.push(s), m[t][e] = s;
                                    else g.push.apply(g, v), m[t] = v.slice(0);
                                else m[t] = [];
                        ...
                        buildTicks: function() {
                            var t, e, n, i = this,
                                ...
                                l = s.time,
                                d = l.displayFormats,
                                p = i.getLabelCapacity(a),
                                v = l.unit || c(l.minUnit, a, o, p),
                                y = h(v),
                                b = [],
                                x = [];
                        ...
                        tickFormatFunction: function(t, e, n) {
                            var i = this,
                                ...
                                o = i._majorUnit,
                                s = i._majorFormat,
                                l = t.clone().startOf(i._majorUnit).valueOf(),
                                u = a.ticks.major,
                                d = u.enabled && o && s && r === l,
                                c = t.format(d ? s : i._minorFormat),
                                h = d ? u : a.ticks.minor,
                                f = y.valueOrDefault(h.callback, h.userCallback);
                            return f ? f(c, e, n) : c
                        },
                        ...
                        getLabelCapacity: function(t) {
                            ...
                            var n = e.tickFormatFunction(p(t), 0, []),
                                i = e.getLabelWidth(n),
